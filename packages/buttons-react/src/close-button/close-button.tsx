...
export interface ReactCloseBtnProps
  extends CloseBtnProps, Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "type"> {
  /**
 ...
 * ```
 */
export const CloseBtn = forwardRef<HTMLButtonElement, ReactCloseBtnProps>(function CloseBtn(
