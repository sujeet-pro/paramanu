...
// All typography component CSS files
const componentDirs = [
  "text",
  "heading",
  "blockquote",
...
writeFileSync(resolve(cssDistDir, "typography.css"), readable)

// Write minified version
const { code: minified } = transform({
  filename: "typography.min.css",
  code: Buffer.from(fullCss),
  minify: true,
  sourceMap: false,
})
writeFileSync(resolve(cssDistDir, "typography.min.css"), minified)

// Write layers version
writeFileSync(resolve(cssDistDir, "typography.layers.css"), readable)
...
console.log("  -> dist/css/typography.min.css")
console.log("  -> dist/css/typography.layers.css")
