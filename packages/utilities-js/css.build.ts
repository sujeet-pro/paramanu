...
// CSS-based utility component dirs
const componentDirs = [
  "visually-hidden",
  "skip-nav",
  "show-hide",
...
writeFileSync(resolve(cssDistDir, "utilities.css"), readable)

const { code: minified } = transform({
  filename: "utilities.min.css",
  code: Buffer.from(fullCss),
  minify: true,
  sourceMap: false,
})
writeFileSync(resolve(cssDistDir, "utilities.min.css"), minified)

writeFileSync(resolve(cssDistDir, "utilities.layers.css"), readable)
...
console.log("  -> dist/css/utilities.css")
console.log("  -> dist/css/utilities.min.css")
console.log("  -> dist/css/utilities.layers.css")
