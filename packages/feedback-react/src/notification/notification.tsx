...
export interface ReactNotifProps
  extends NotifClassesOptions, Omit<React.HTMLAttributes<HTMLDivElement>, "title"> {
 ...
 */
export const Notif = forwardRef<HTMLDivElement, ReactNotifProps>(function Notif(
  {
    variant,
    unread,
    dismissible,
  ...
  return (
    <div ref={ref} className={combinedClassName} role="article" {...rest}>
      ...
      <div className={classes.content}>
        ...
        {timestamp && <time className={classes.timestamp}>{timestamp}</time>}
