...
export const CardHeader = forwardRef<HTMLDivElement, ReactCardHeaderProps>(
...
export const CardBody = forwardRef<HTMLDivElement, ReactCardBodyProps>(
...
export const CardFooter = forwardRef<HTMLDivElement, ReactCardFooterProps>(
...
export const CardMedia = forwardRef<HTMLDivElement, ReactCardMediaProps>(
  function CardMedia({ position, className, children, ...rest }, ref) {
