...
export interface ReactAvatarGrpProps
  extends AvatarGrpClassesOptions, React.HTMLAttributes<HTMLDivElement> {
  max?: number
  children?: React.ReactNode
}

export const AvatarGrp = forwardRef<HTMLDivElement, ReactAvatarGrpProps>(function AvatarGrp(
  { size, spacing, max, className, children, ...rest },
  ref,
) {
