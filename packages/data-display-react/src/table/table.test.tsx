...
describe("Table", () => {
  ...
  it("applies variant class", () => {
    render(<Table variant="striped" data-testid="table"><tbody><tr><td>Cell</td></tr></tbody></Table>)
    expect(screen.getByTestId("table").className).toContain("pm-table--striped")
  })

  it("applies hoverable modifier", () => {
    render(<Table hoverable data-testid="table"><tbody><tr><td>Cell</td></tr></tbody></Table>)
    expect(screen.getByTestId("table").className).toContain("pm-table--hoverable")
  })

  it("forwards ref", () => {
    let tableRef: HTMLTableElement | null = null
    render(<Table ref={(el) => (tableRef = el)}><tbody><tr><td>Cell</td></tr></tbody></Table>)
    expect(tableRef).toBeInstanceOf(HTMLTableElement)
  })

  it("merges custom className", () => {
    render(<Table className="custom" data-testid="table"><tbody><tr><td>Cell</td></tr></tbody></Table>)
    const table = screen.getByTestId("table")
    expect(table.className).toContain("pm-table")
...
describe("TableHead", () => {
  it("renders with head class", () => {
    render(
      <table>
        <TableHead data-testid="head"><tr><th>Header</th></tr></TableHead>
        <tbody><tr><td>Cell</td></tr></tbody>
      </table>,
    )
...
describe("TableRow", () => {
  it("renders with row class", () => {
    render(
      <table><tbody><TableRow data-testid="row"><td>Cell</td></TableRow></tbody></table>,
    )
...
describe("TableHeaderCell", () => {
  it("renders with header-cell class", () => {
    render(
      <table><thead><tr><TableHeaderCell data-testid="th">Header</TableHeaderCell></tr></thead><tbody><tr><td>Cell</td></tr></tbody></table>,
    )
