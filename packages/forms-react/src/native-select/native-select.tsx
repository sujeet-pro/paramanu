...
export interface ReactNativeSelProps
  extends NativeSelProps, Omit<React.SelectHTMLAttributes<HTMLSelectElement>, "size"> {
  children?: React.ReactNode
}

export const NativeSel = forwardRef<HTMLSelectElement, ReactNativeSelProps>(function NativeSel(
  { variant, size, disabled, invalid, fullWidth, className, children, ...rest },
  ref,
) {
