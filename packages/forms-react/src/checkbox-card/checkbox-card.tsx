...
export interface ReactChkCardProps
  extends ChkCardProps, Omit<React.InputHTMLAttributes<HTMLInputElement>, "size" | "type"> {
  children?: React.ReactNode
}

export const ChkCard = forwardRef<HTMLInputElement, ReactChkCardProps>(function ChkCard(
  { size, disabled, checked, className, children, ...rest },
  ref,
) {
